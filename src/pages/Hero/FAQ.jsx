...
<span className=" text-base">Missing credit card bills will not lead to loan rejection. The lender only looks for the history of payment habits and whether potential customers have the ability to consistently make their payments on time. Most lenders do accept partial payments on credit cards but if you miss three consecutive payments then you will be considered delinquent. If you continue with this behavior, your application for a loan or other type of financing may be declined or put on hold indefinitely until the problem has been resolved
                    ...
                    <div>
                        ...
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 " + (show3 ? "block" : "hidden")}>Looking to improve your credit score quickly? Start by paying your bills on time, reducing your credit card balances and disputing any errors on your credit report. These simple steps can help improve your credit score in a matter of weeks. Remember, building a good credit score takes time and effort, but with patience and discipline, you can reach your financial goals and enjoy the benefits of a good credit score.
</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 " + (show4 ? "blcok" : "hidden")}>Have you missed an instalment payment on your loan? Unfortunately, this can negatively impact your credit score and financial health. Your lender may charge a late fee or penalty, and your credit score may be affected. In addition, missing multiple payments can lead to a loan default, which can result in legal action, loss of collateral or even bankruptcy. If you're having trouble making your EMI payments, be sure to contact your lender and discuss your options, such as rescheduling your loan or extending the repayment period or try <Link to="/Refine" className="text-blue-800 font-semibold">  Credit Refine </Link>. Ignoring the problem will only make it worse. So stay proactive and take steps to avoid missing EMI payments.
</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className={"font-normal text-base leading-6 text-gray-600 mt-4 w-11/12 " + (show5 ? "blcok" : "hidden")}>Need to change the repayment terms of your loan? It's easy! Simply contact your lender and request the change. Depending on the lender's policies, you may be able to change from one repayment method to another, such as from EMI to ECS or vice versa. Be prepared to provide your loan account number, the new repayment method, and any other necessary information. Once the change is made, monitor your loan account and ensure payments are deducted according to the new payment method. Remember that on-time payments are crucial to maintain a good credit score and avoid penalties. So don't hesitate to make the change if it'll help you better manage your credit.
